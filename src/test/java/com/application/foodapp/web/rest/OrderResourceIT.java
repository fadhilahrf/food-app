...
class OrderResourceIT {
    ...
    private static final OrderStatus DEFAULT_STATUS = OrderStatus.ACTIVE;
    private static final OrderStatus UPDATED_STATUS = OrderStatus.SENDING;
    ...
    public static Order createEntity() {
        Order order = new Order().status(DEFAULT_STATUS);
        return order;
    }
    ...
    public static Order createUpdatedEntity() {
        Order order = new Order().status(UPDATED_STATUS);
        return order;
    }

...
describe('Food Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'food', component: FoodComponent }]), HttpClientTestingModule, FoodComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.foods?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
